...
class_name RTS_MoveAbility extends RTS_Ability
...
func move(movables: Array[RTS_Movable]):
	var world_pos = RTS_Controls.movement.get_current_mouse_world_pos()
	last_move_target_source = null
	if RTS_Controls.selection.hovered_pickable != null:
		last_move_target_source = RTS_Controls.selection.hovered_pickable.entity
