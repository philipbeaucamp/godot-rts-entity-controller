...
func set_component_active():
	...
	steering.set_collision_mask_value(RTS_Controls.settings.collision_layer_units,true)
	steering.set_collision_mask_value(RTS_Controls.settings.collision_layer_buildings_and_rocks,true)
