...
func set_faction(faction: RTS_Entity.Faction):
	if faction == RTS_Entity.Faction.PLAYER:
		area.set_collision_layer_value(RTS_Controls.settings.collision_layer_player_defense,true)
		area.set_collision_mask_value(RTS_Controls.settings.collision_layer_enemy_attack,true) 
	else:
		area.set_collision_layer_value(RTS_Controls.settings.collision_layer_enemy_defense,true) 
		area.set_collision_mask_value(RTS_Controls.settings.collision_layer_player_attack,true)
